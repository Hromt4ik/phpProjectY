...
<nav class="nav">
        ...
        <form class="form form--add-lot container <?php if (!isset($errors)): ?>form--invalid<?php endif; ?> " enctype="multipart/form-data" action="add.php" method="post"> <!-- form--invalid -->
            ...
            <div class="form__container-two">
                ...
                <div class="form__item">
                    ...
                    <select id="category"  name="category">
                        <?php foreach ($categories as $item): ?>
                            <option value="<?= $item['Id'] ?>"><?= htmlspecialchars($item['NameCategory']) ?></option>
                        <?php endforeach; ?>
                    </select>
                    <span class="form__error">Выберите категорию</span>
                </div>
            </div>
            <div class="form__item <?php if (isset($errors['message'])): ?> form__item--invalid <?php endif; ?> form__item--wide">
