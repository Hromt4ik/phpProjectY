...
<div class="container">
    ...
    <ul class="pagination-list">
        <li class="pagination-item pagination-item-prev"><a href="searchs.php?search=<?=$search_str ?>&find=Найти&page=<?=$curr_page - 1?>">Назад</a></li>
        ...
        <li class="pagination-item pagination-item-next"><a href="searchs.php?search=<?=$search_str ?>&find=Найти&page=<?=$curr_page + 1?>">Вперед</a></li>
    </ul>
    <?php else:?>
