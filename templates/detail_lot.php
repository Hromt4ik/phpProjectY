    ...
    <section class="lot-item container">
        ...
        <div class="lot-item__content">
            <div class="lot-item__left">
                ...
                <p class="lot-item__category">Категория: <span><?=$lots['NameLot']?></span></p>
                <p class="lot-item__description"><?=$lots['Detail']?></p>
            </div>
            <div class="lot-item__right">
                <div class="lot-item__state">
                    ...
                    <div class="lot-item__timer timer <?php if($date_end[0] < '24'):?> timer--finishing <?php endif; ?>">
                    ...
                    <div class="lot-item__cost-state">
                        <div class="lot-item__rate">
                            ...
                            <span class="lot-item__cost"><?=format_price($lots['StartPrise'])?></span>
                        </div>
                    ...
                    <form class="lot-item__form <?php if (!isset($_SESSION['is_auth']) || !$_SESSION['is_auth']):?>visually-hidden<?php endif; ?>" action="lot.php?Id=<?=$_GET['Id']?>" method="post" autocomplete="off">
                        <p class="lot-item__form-item form__item <?php if (isset($errors['cost'])): ?>form__item--invalid <?php endif; ?>">
                            ...
                            <input id="cost" type="text" name="cost" placeholder="<?=format_price($min_bet)?>" value="<?=getPostVal('cost')?>">
                ...
                <div class="history">
                    ...
                    <table class="history__list">
                        <?php foreach ($bet_lots as $item):?>
                            ...
                            <td class="history__price"><?=htmlspecialchars(format_price($item['Sum']))?></td>
                            <td class="history__time"><?=formate_date($item['DateCreate'])?></td>
                        </tr>
                        <?php endforeach;?>
